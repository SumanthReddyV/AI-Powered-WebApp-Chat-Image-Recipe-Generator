...
function ImageGenerator() {
    ...
    return (
        <div className="tab-content">
            ...
            <div>
                       <p>(Note : The image url is valid upto 60 mintues.Download to save the image generated.)
                        </p>
                    <p> <b>(Reminder: This feature uses paid API calls — please use it responsibly. ) </b>   
                        </p> 
                        </div>
        </div>
    );
